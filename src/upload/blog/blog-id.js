...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    return {
      ...
      public_id: `blog-detail-${Date.now()}-${file.originalname}`,
    };
  },
});
...
}).single('blogDetailBanner');

const uploadBlogId = (req, res, next) => {
